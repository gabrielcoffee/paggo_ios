...
import { PaymentPix } from '@/modules/payment/pix';

type IndexPageRef = React.ForwardedRef<HTMLDivElement>;

function PaymentPixHome(_: undefined, ref: IndexPageRef) {
  ...
  return (
    <PageTransition ref={ref}>
      <div className="scrollbar-hide flex h-full w-full flex-col gap-4 overflow-auto pb-12">
        ...
        {!checkingLocation && <PaymentPix />}
      </div>
    </PageTransition>
  );
}

export default forwardRef(PaymentPixHome);
